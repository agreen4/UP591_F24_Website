...
+-------------------+---------------------------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| **May 16**        | Capstone Submission Deadline                      | -   Upload your final capstone deliverables *including adviser signature, if required* before this date (more details below).                                                                               |
+-------------------+---------------------------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
Planning at Illinois students can use the large format printers in TBH Room 21 to print their posters. There are specific step-by-step instructions posted in the lab.  Below are some additional  general tips:

- The lab is staffed every weekday from 9am-9pm and weekends from 12-5pm.  Student lab staff are there to help you.

- To print posters, you will have to log onto a computer in the lab (there are 6 computers).

  + Recommended Poster Size is 24*36
  ...
  + Printer Options:
    ...
    - **Printer Z6200-1 and Printer Z6200-2:** These are also higher quality (semi-gloss) that may be better for your final poster.  These cost more than XL4100.

    - Costs come directly out of your student account.
    
Note: Given the high demand for printing, particularly at the end of the semester, be sure to have a plan to print your poster early.
...
- For students pursuing the workshop option, you do not need any signatures on your exit form submission
...
During finals week in May you will upload your [capstone exit form](https://web.faa.illinois.edu/app/uploads/sites/2/2025/05/04_CapstoneExit.pdf) with advisor and client signatures if applicable, final poster, final portfolio, and project or thesis manuscript (for Project / Thesis pathways). Please follow these naming conventions for your Box uploads:

-   LastName_FirstName_ExitForm.pdf - [exit form](https://web.faa.illinois.edu/app/uploads/sites/2/2025/05/04_CapstoneExit.pdf)
...
After you upload your Exit Materials, please email the Director of Graduate Studies who will review your materials, and given satisfactory completion of all exit requirements who will sign off on your [Capstone Exit Form](https://web.faa.illinois.edu/app/uploads/sites/2/2025/05/04_CapstoneExit.pdf) to certify your completion of all capstone requirements associated with the MUP degree.
